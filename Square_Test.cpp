...
void Unit_Testing (void)
  {
    ...
    const STRUCT_FOR_TEST data[] = { //coef         data_right
                                     {{1, -7, 12}, {4, 3, 2}},
                                     {{1.5, -7, 2}, {Rounding_doubles(4.36092), Rounding_doubles(0.305746), 2}},
                                     {{78,58.86, -300}, {Rounding_doubles(1.61982), Rounding_doubles(-2.37443), 2}},
                                     {{0.783, -0.855, 0.05}, {Rounding_doubles(1.02995), Rounding_doubles(0.0619998), 2}}
                                   };
